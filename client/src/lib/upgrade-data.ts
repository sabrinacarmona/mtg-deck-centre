...
export const UPGRADE_SUGGESTIONS: Record<string, UpgradeSuggestion[]> = {
  ...
  "Gonti, Canny Acquisitor": [
    { cardName: "Thieving Skydiver", price: "$2", reason: "Steals artifacts when kicked, perfect theft theme", category: "synergy" },
    { cardName: "Spark Double", price: "$5", reason: "Copies Gonti for double ETB theft triggers", category: "synergy" },
    { cardName: "Panharmonicon", price: "$8", reason: "Doubles ETB triggers, steals twice as much", category: "synergy" },
    { cardName: "Deadeye Navigator", price: "$3", reason: "Flickers Gonti repeatedly for infinite theft", category: "synergy" },
    { cardName: "Rogue's Passage", price: "$0.50", reason: "Makes Gonti unblockable to trigger theft consistently", category: "synergy" },
    { cardName: "Heroic Intervention", price: "$5", reason: "Protects your stolen goods from removal", category: "protection" },
    { cardName: "Eternal Witness", price: "$2", reason: "Recurs your best spells from graveyard", category: "draw" },
    { cardName: "Beast Within", price: "$2", reason: "Flexible removal for any permanent", category: "removal" },
  ],
